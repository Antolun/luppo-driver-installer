#!/usr/bin/env python3
"""
Main Entry Point for Graphics Driver Installer.
"""
...
from config import APP_NAME, APP_ORGANIZATION, APP_VERSION
...
def main():
    ...
    icon_path = os.path.join(SCRIPT_DIR, "assets", "graphics-driver-installer.png")
