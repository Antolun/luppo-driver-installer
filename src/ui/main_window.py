"""
Main Window for LupuS Luppo Driver Installer.
"""
...
from src.backend.worker import HardwareScanWorker, PackageCheckWorker, DriverActionWorker
from src.ui.style import MAIN_STYLE
...
class MainWindow(QMainWindow):
    ...
    def _on_hardware_scan_finished(self, gpus: list):
        ...
        self.drivers_view.show_progress(tr("progress_querying_luppo"), 60)
