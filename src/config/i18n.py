"""
Internationalization (i18n) module for Luppo Driver Installer.
...
TRANSLATIONS = {
    "en": {
        # App Info
        "app_name": "Luppo Driver Installer",
        "app_subtitle": "Install, Remove, and Manage GPU Drivers on LupuS",
        ...
        "progress_querying_luppo": "Querying Luppo package database...",
        ...
        "luppo_mgmt_title": "Luppo Repository and Cache Management",
        "luppo_mgmt_desc": "Refresh Luppo package manager database or clear download cache.",
        "btn_update_repo": " Update Repositories (luppo update-repo)",
        "btn_clean_cache": " Clear Cache (luppo delete-cache)",
        "msg_hybrid_title": "Hybrid Graphics Profile",
        "msg_hybrid_text": "Graphics mode set to '{mode}'.\nLog out and log back in for changes to take effect.",
        "msg_luppo_cache_title": "Luppo Cache",
        "msg_luppo_cache_text": "Luppo package cache was successfully cleared.",
        ...
        "log_install_req": "[LUPPO] Install request received: {pkg}",
        "log_remove_req": "[LUPPO] Remove request received: {pkg}",
        "log_repo_req": "[LUPPO] Repository update request received.",
        ...
        # Backend Workers / Detectors / Luppo
        ...
        "worker_luppo_querying": "[LUPPO] Querying driver package statuses from Luppo database...",
        "worker_luppo_status": "[LUPPO] {pkg}: Status -> {status} (Version: {version})",
        ...
        # Luppo Backend messages
        "luppo_install_start": "Starting installation of {pkg_name} package...",
        "luppo_cmd_install": "[LUPPO] Install command: luppo install {cmd}",
        "luppo_verifying_repos": "[LUPPO] Verifying repository indices...",
        "luppo_downloading": "[LUPPO] Downloading: {pkg} ({size})",
        "luppo_unpacking": "[LUPPO] Unpacking packages and checking dependencies...",
        "luppo_copying_files": "[LUPPO] Copying driver files and compiling modules...",
        "luppo_updating_xorg": "[LUPPO] Updating Xorg and DKMS configuration...",
        "luppo_install_done": "[LUPPO] {pkg} installed successfully!",
        "luppo_install_comp_msg": "Installation completed successfully!",
        "luppo_install_comp_log": "[LUPPO] Operation completed successfully.",
        "luppo_err_exit_code": "Error! Exit code: {code}",
        "luppo_err_install_fail": "[ERROR] luppo install failed ({code})",
        "luppo_exception": "[EXCEPTION] {msg}",
        "luppo_remove_start": "Removing {pkg} package...",
        "luppo_cmd_remove": "[LUPPO] Remove command: luppo remove {pkg}",
        "luppo_checking_deps": "[LUPPO] Checking package dependencies...",
        "luppo_deleting_files": "[LUPPO] Deleting driver files from system...",
        "luppo_refreshing_mods": "[LUPPO] Refreshing system module configuration...",
        "luppo_remove_done": "[LUPPO] {pkg} package(s) removed!",
        "luppo_remove_comp_msg": "Package removed!",
        "luppo_remove_comp_log": "[LUPPO] Package deleted successfully.",
        "luppo_err_remove_fail": "[ERROR] luppo remove failed ({code})",
        "luppo_update_repos_start": "Updating repository databases...",
        "luppo_cmd_update_repo": "[LUPPO] Running luppo update-repo",
        "luppo_downloading_repos": "Downloading repositories...",
        "luppo_updating_repos_log": "[LUPPO] Updating core, main, contrib repositories...",
        "luppo_repos_updated_msg": "Repositories updated!",
        "luppo_repos_updated_log": "[LUPPO] Repository update completed.",
    },
    "tr": {
        # App Info
        "app_name": "Luppo Sürücü Kurucu",
        "app_subtitle": "LupuS Üzerinde GPU Sürücülerini Kurun, Kaldırın ve Yönetin",
        ...
        "progress_querying_luppo": "Luppo paket veritabanı sorgulanıyor...",
        ...
        "luppo_mgmt_title": "Luppo Depo ve Önbellek Yönetimi",
        "luppo_mgmt_desc": "Luppo paket yöneticisi veritabanını yenileyin veya indirme önbelleğini temizleyin.",
        "btn_update_repo": " Depoları Güncelle (luppo update-repo)",
        "btn_clean_cache": " Önbelleği Temizle (luppo delete-cache)",
        ...
        "msg_luppo_cache_title": "Luppo Önbelleği",
        "msg_luppo_cache_text": "Luppo paket önbelleği başarıyla temizlendi.",
        ...
        "log_install_req": "[LUPPO] Kurulum isteği alındı: {pkg}",
        "log_remove_req": "[LUPPO] Kaldırma isteği alındı: {pkg}",
        "log_repo_req": "[LUPPO] Depo güncelleme isteği alındı.",
        ...
        "worker_luppo_querying": "[LUPPO] Sürücü paket durumları Luppo veritabanından sorgulanıyor...",
        "worker_luppo_status": "[LUPPO] {pkg}: Durum -> {status} (Sürüm: {version})",
        ...
        # Luppo Backend messages
        "luppo_install_start": "{pkg_name} paket kurulumu başlatılıyor...",
        "luppo_cmd_install": "[LUPPO] Kurulum komutu: luppo install {cmd}",
        "luppo_verifying_repos": "[LUPPO] Depo indeksleri doğrulanıyor...",
        "luppo_downloading": "[LUPPO] İndiriliyor: {pkg} ({size})",
        "luppo_unpacking": "[LUPPO] Paket paket açılıyor ve bağımlılıklar kontrol ediliyor...",
        "luppo_copying_files": "[LUPPO] Sürücü dosyaları kopyalanıyor ve modüller derleniyor...",
        "luppo_updating_xorg": "[LUPPO] Xorg ve DKMS yapılandırması güncelleniyor...",
        "luppo_install_done": "[LUPPO] {pkg} başarıyla kuruldu!",
        "luppo_install_comp_msg": "Kurulum başarıyla tamamlandı!",
        "luppo_install_comp_log": "[LUPPO] İşlem başarıyla tamamlandı.",
        "luppo_err_exit_code": "Hata! Çıkış kodu: {code}",
        "luppo_err_install_fail": "[HATA] luppo install başarısız oldu ({code})",
        "luppo_exception": "[İSTİSNA] {msg}",
        "luppo_remove_start": "{pkg} paketi kaldırılıyor...",
        "luppo_cmd_remove": "[LUPPO] Kaldırma komutu: luppo remove {pkg}",
        "luppo_checking_deps": "[LUPPO] Paket bağımlılıkları kontrol ediliyor...",
        "luppo_deleting_files": "[LUPPO] Sürücü dosyaları sistemden siliniyor...",
        "luppo_refreshing_mods": "[LUPPO] Sistem modül yapılandırması yenileniyor...",
        "luppo_remove_done": "[LUPPO] {pkg} paket(ler)i kaldırıldı!",
        "luppo_remove_comp_msg": "Paket kaldırıldı!",
        "luppo_remove_comp_log": "[LUPPO] Paket başarıyla silindi.",
        "luppo_err_remove_fail": "[HATA] luppo remove başarısız oldu ({code})",
        "luppo_update_repos_start": "Depo veritabanları güncelleniyor...",
        "luppo_cmd_update_repo": "[LUPPO] luppo update-repo çalıştırılıyor",
        "luppo_downloading_repos": "Depolar indiriliyor...",
        "luppo_updating_repos_log": "[LUPPO] core, main, contrib depoları güncelleniyor...",
        "luppo_repos_updated_msg": "Depolar güncellendi!",
        "luppo_repos_updated_log": "[LUPPO] Depo güncelleme tamamlandı.",
    }
}
