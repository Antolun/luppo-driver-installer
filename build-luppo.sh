...
echo "=========================================="
echo " Luppo Driver Installer — Luppo Package Builder"
echo "=========================================="

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
export LDI_SRC_DIR="${SCRIPT_DIR}"
cd "${SCRIPT_DIR}"
...
LUPPO_FILE=$(find . /var/luppo /tmp -name "luppo-driver-installer-*.luppo" 2>/dev/null | head -n 1 || true)
